...
public class MainActivity extends AppCompatActivity {
            ...
            mUploadTask = fileReference.putFile(mImageUri)
                    .addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                        ...
                        public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                            ...
                            Upload upload = new Upload(mTag.getText().toString().trim(),mEditTextFileName.getText().toString().trim(),
                            ...
                            /*Upload uploadtag = new Upload(mTag.getText().toString().trim(),
                                    taskSnapshot.getDownloadUrl().toString());
                            String uploadtagId = mDatabaseRef.push().getKey();
                            mDatabaseRef.child(uploadtagId).setValue(uploadtag);
                            String urltag = taskSnapshot.getDownloadUrl().toString();
                            Log.d(TAG, "onSuccessTag: successtag"+urltag);*/
                        }
                    })
    ...
    private void openImagesActivity(){
        ...
        intent.putExtra("Name", mEditTextFileName.getText().toString());
